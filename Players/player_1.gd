...
func player_input():
	direction.y = Input.get_axis("Player_1_UP", "Player_1_DOWN")
	direction.x = Input.get_axis("Player_1_LEFT", "Player_1_RIGHT")
	rotation_direction = Input.get_axis("Player_1_Rotate_LEFT","Player_1_Rotate_RIGHT")
