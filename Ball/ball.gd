...
func _ready():
	...
	Global.current_ball_bounce_animation_number = 0
	Global.current_ball_idle_animation_number = 0
	add_to_group("Ball", true)
...
func spawn_parameters():
	...
	animation_player.play(Global.ball_idle_animations[Global.current_ball_idle_animation_number])
...
func movement(delta):
	...
	if collision:
		...
		animation_player.play(Global.ball_bounce_animations[Global.current_ball_bounce_animation_number])
...
func special_ball_chance():
	var random_special_ball_chance_number: int = randi_range(1, 20) 
	if random_special_ball_chance_number > 18:
		Global.current_ball_idle_animation_number = 1
		Global.current_ball_bounce_animation_number = 1
	else:
		Global.current_ball_idle_animation_number = 0
		Global.current_ball_bounce_animation_number = 0
